...
public class CPessoa implements InterfaceController<Pessoa>{
    ...
    public boolean verCPF(String cpf) { /// metodo verifica cpf 
    ...
    public boolean verStatusPes(String cpf) { // metodo verifica status 
    ...
    public void alteraStatus(String cpf, int status) { // metodo para alterar status 
        for (Pessoa listPes : pessoas) {
            if (listPes.getCpf().equals(cpf)) {
